...
public abstract class Box {
	/** Stores the movingBox as a Rectangle2D */
	private Rectangle2D rect;
	/** The position of the movingBox */
	public Point2D pos;
	/** The width of the movingBox */
	...
	/**
	 * Constructs a square movingBox at a position width a side width
	 * bottom-left corner, as well as the width and height.
	 * 
	 * @param pos
	 *            the position of the movingBox
	...
	/**
	 * returns the width of the movingBox
	 */
	public double getWidth() {return width;}


	/**
	 * returns the position of the movingBox
	 */
	public Point2D getPos() {
	    return pos;
    }
	/**
	 * Returns a copy of the Rectangle2D representing the movingBox.
	 * 
	 * @return a copy of the Rectangle2D representing the movingBox.
	 */
	...
	/**
	 * Returns a String representation of the movingBox.
	 *
	 * @return a String representation of the movingBox.
	 */
